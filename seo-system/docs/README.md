> **Layout:** run from seo-system with `node generators/generate-pages.js` (also generate-loan-pages.js and generate-longtail.js). Output lands in output/converters, output/loans and output/longtail; copy from there into calculator-types/. The folder diagram below is the original layout.
